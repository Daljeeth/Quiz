...
namespace Quiz
{
    public partial class Ahard : Form
    {
        public Ahard()
        {
            InitializeComponent();
        ...
        public void hard()
        {
            String myConnection = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\Daljeet\Documents\Visual Studio 2013\Projects\Quiz\Quiz\Database1.mdf;Integrated Security=True;Connect Timeout=305";
            SqlConnection myconn = new SqlConnection(myConnection);

            myconn.Open();
           SqlCommand cmdDataBase1 = new SqlCommand("select * FROM ahard;", myconn);
           SqlCommand cmdDataBase2 = new SqlCommand("insert into stats_tab select * from ahard;", myconn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand p1 = new SqlCommand("select * from quizdb.stats_tab where slno = @slno;",myconn);
