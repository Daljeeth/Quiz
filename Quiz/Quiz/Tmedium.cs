...
namespace Quiz
{
    public partial class Tmedium : Form
    {
        public Tmedium()
        {
            InitializeComponent();
        ...
        public void medium()
        {
            ...
            myconn.Open();
            SqlCommand cmdDataBase1 = new SqlCommand("select * FROM tmedium;", myconn);
            SqlCommand cmdDataBase2 = new SqlCommand("insert into stats_tab select * from tmedium;", myconn);
        ...
        private void Tmedium_Load(object sender, EventArgs e)
        {
            this.TopMost = true;
