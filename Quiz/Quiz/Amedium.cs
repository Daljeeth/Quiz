...
namespace Quiz
{
    public partial class Amedium : Form
    {
        public Amedium()
        {
            InitializeComponent();
        ...
        public void medium()
        {
            ...
            myconn.Open();
            SqlCommand cmdDataBase1 = new SqlCommand("select * FROM amedium;", myconn);
            SqlCommand cmdDataBase2 = new SqlCommand("insert into stats_tab select * from amedium ;", myconn);
            SqlCommand cmdDataBase3 = new SqlCommand("select * from quizdb.stats_tab where slno =1;", myconn);
        ...
        private void Amedium_Load(object sender, EventArgs e)
        {
