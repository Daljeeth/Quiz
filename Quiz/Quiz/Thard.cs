...
namespace Quiz
{
    public partial class Thard : Form
    {
        public Thard()
        {
            InitializeComponent();
        ...
        public void hard()
        {
            ...
            myconn.Open();
            SqlCommand cmdDataBase1 = new SqlCommand("select * FROM thard;", myconn);
            SqlCommand cmdDataBase2 = new SqlCommand("insert into stats_tab select * from thard;", myconn);
        ...
        public void insert()
        {
            ...
            try
            {
                SqlCommand c11 = new SqlCommand("select * quizdb.stats_tab where slno=@slno;", myconn1);
        ...
        private void Thard_Load(object sender, EventArgs e)
        {
            this.TopMost = true;
