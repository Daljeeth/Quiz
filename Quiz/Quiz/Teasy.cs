...
namespace Quiz
{
    public partial class Teasy : Form
    {
        public Teasy()
        {
            InitializeComponent();
        ...
        public void easy()
        {
            ...
            myconn.Open();
            SqlCommand cmdDataBase1 = new SqlCommand("select * FROM teasy;", myconn);
            SqlCommand cmdDataBase2 = new SqlCommand("insert into stats_tab select * from teasy ;", myconn);
        ...
        private void Teasy_Load(object sender, EventArgs e)
        {
